...
def IntegratedGradients(img):    
        model = VGG16(weights="imagenet", include_top=True)
        model.compile(optimizer='sgd', loss='categorical_crossentropy') 
        
        ig = integrated_gradients(model)
        
        #img = image.load_img("D:\\MM811\\Project\\Implementation\\keras-networks\\images\\bmw.png", target_size=(224, 224))
        ...
        f = open('human_readable_label.txt','r')
        labels = eval(f.read())
        f.close()
